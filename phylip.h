...
typedef void (*initptr2)(node **, node **, node *, long, long,
                         long *, long *, initops, pointarray,
                         pointarray, Char *, Char *, char **, int, int*);
...
void   getch3(Char *, long *,char **,int,int);
...
void   processlength2(double *,double *,Char *,boolean *,long *, char **, int, int *);
...
long   countcomma(long *,int,char **);
long   countsemic(FILE **);
void   hookup(node *, node *);
void   unhookup(node *, node *);
void   link_trees(long, long , long, pointarray);
void   allocate_nodep(pointarray *,long *,int ,char **);

void   malloc_pheno(node *, long, long);
void   malloc_ppheno(node *, long, long);
long   take_name_from_tree (Char *, Char *, FILE *);
long   take_name_from_tree2 (Char *, Char *, char **, int, int *);
void   match_names_to_data (Char *, pointarray, node **, long);
void   addelement(node **, node *, Char *, long *, pointarray,
                boolean *, boolean *, pointarray, long *, long *, boolean *,
                node **, initptr2,boolean,long,char **,int,int*);
void   treeread (node **, pointarray, boolean *, boolean *,
                pointarray, long *, boolean *, node **, initptr2,boolean,long,char**,int);
